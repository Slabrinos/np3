...
OPENCODE_ZEN_API_KEY = (
    "sk-ROur0EUGsKTqCaeHmD9TLpZmnudNeUtg0Z9HiPDsSYOQ7d0xKsrqzpYKGUdaWD70"
)

class FreePedagogicalAgent:
    """
    Pedagogical AI agent μέσω OpenCode Zen + Big Pickle.
    ...
    def __init__(self) -> None:
        self.model_name = OPENCODE_ZEN_MODEL
        self.client = None
        self.agent = None
        ...
        try:
            ...
            if not api_key:
                raise RuntimeError(
                    "Λείπει το OPENCODE_ZEN_API_KEY environment variable."
                )
    ...
    def _extract_json(text: str) -> Dict[str, Any]:
        """
        Εξάγει JSON object ακόμα και αν το μοντέλο επιστρέψει
        ...
        raise ValueError(
            "Ο Big Pickle agent δεν επέστρεψε έγκυρο JSON."
        )
